...
public class ProductServiceImpl implements ProductsService {
    ...
    public ProductServiceImpl(ProductRepository productRepository, ModelMapper modelMapper, CompanyRepository companyRepository, UserRepository userRepository, ShoppingCartService shoppingCartService) {
    ...
    public void addProduct(ProductAddBindingModel productAddBindingModel, Object email) throws Throwable {
        Company company = companyRepository.findByName(productAddBindingModel.getCompany()).orElseThrow(() -> new Throwable("Company with name " + productAddBindingModel.getCompany() + " not found!"));
